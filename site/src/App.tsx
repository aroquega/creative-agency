    ...
    <>
      ...
      <main>
        ...
        <div className="bg-red md:bg-inherit px-6 py-24 md:p-0 text-white md:flex">
          ...
          <ul className="mt-[49px] md:-mt-[120px] xl:-mt-[200px] xl:flex-1 lg:-ml-[160px] lg:pr-[150px] space-y-10 lg:space-y-14 md:bg-red relative md:py-[120px] md:pl-[43px] md:pr-[40px] lg:pl-[285px] lg:py-[200px]">
